"""
Django settings for ErrorLogClustering project.
...
config_path = "ErrorLogClustering/config-example.ini"
...
ROOT_URLCONF = 'ErrorLogClustering.urls'
...
WSGI_APPLICATION = 'ErrorLogClustering.wsgi.application'
